...
public class ProductAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.t2 = convertView.findViewById(R.id.tvPrice);
            holder.t3=convertView.findViewById(R.id.tvSell);
        ...
        holder.t2.setText("Before: "+list.get(position).getBeforeDiscount()
        +"TK  Now: "+list.get(position).getAfterDiscount()+"TK");
        holder.t3.setText("Total Sells: "+list.get(position).getSells());
        return convertView;
    }
